...
const MyAppointments = () => {
    ...
    if (loading) return <div className="page-container" style={{ minHeight: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center', background: '#1a1a1a', color: 'white' }}><h2>Loading your appointments...</h2></div>;

    return (
        <div className="page-container" style={{
            backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.65), rgba(0, 0, 0, 0.75)), url("/stethoscope-bg.png")',
            ...
            <h2 style={{ color: '#ffffff', fontSize: '2.5rem', borderBottom: '2px solid rgba(255,255,255,0.2)', paddingBottom: '10px', display: 'inline-block', marginBottom: '40px', textShadow: '2px 2px 4px rgba(0,0,0,0.6)' }}>My Appointments</h2>
            ...
            <div className="appointments-grid" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '20px', marginTop: '20px' }}>
                {appointments.map((appt) => (
                    ...
                    >
                        <div>
                            <h3 style={{ margin: '0 0 10px 0', fontSize: '1.6rem', color: '#ffffff' }}>Dr. {appt.doctorName}</h3>
                            <p style={{ margin: '5px 0', fontSize: '1.1rem', color: '#e0e0e0' }}>Specialty: <span style={{ fontWeight: 'bold', color: '#fff' }}>{appt.specialtyName}</span></p>
